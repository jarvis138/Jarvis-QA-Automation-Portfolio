...
public class PIMTestRunner extends Setup {
    ...
    // Other test methods follow the same pattern of using explicit waits

    @Test(priority = 3, description = "Doesn't create employee without Username")
    public void createEmployeeWithoutUsername() throws IOException, ParseException {
        ...
        // Assertion
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("oxd-text")));
    ...
    public void createEmployee1() throws IOException, ParseException {
        pimPage = new PIMPage(driver);
        Faker faker = new Faker();
        String firstname = faker.name().firstName();
        String lastname = faker.name().lastName();
    ...
    public void createEmployee2() throws IOException, ParseException {
        pimPage = new PIMPage(driver);
        Faker faker = new Faker();
        String firstname = faker.name().firstName();
        String lastname = faker.name().lastName();
    ...
    public void searchEmployeeByInvalidName() {
        pimPage = new PIMPage(driver);
        dashboardPage = new DashboardPage(driver);
        dashboardPage.menus.get(1).click();
        Faker faker = new Faker();
    ...
    public void searchEmployeeByName() throws IOException, ParseException {
        loginPage = new LoginPage(driver);
    ...
    public void updateEmployeeById() throws IOException, ParseException {
        pimPage = new PIMPage(driver);
        int empId = Utils.generateRandomNumber(10000, 99999);
    ...
    public void searchEmployeeById() throws IOException, ParseException {
        loginPage = new LoginPage(driver);
        dashboardPage = new DashboardPage(driver);
        dashboardPage.menus.get(1).click();
        JSONObject userObject = Utils.loadJSONFileContainingArray("./src/test/resources/Employee.json", 0);
